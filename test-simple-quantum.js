// Test file for Simplified Post-Quantum Cryptography
import SimpleQuantumCrypto from './src/api/crypto/simpleQuantumCrypto.js';

async function testSimpleQuantumCrypto() {
  console.log('🚀 Testing Simplified Post-Quantum Cryptography...\n');
  
  const crypto = new SimpleQuantumCrypto();
  ...
  try {
    ...
    const testMessage = "Hello from the quantum future! 🔐";
    ...
    const chatMessage = "This is a secure group message! 🛡️";
    ...
    console.log('🎉 All tests passed! Simplified post-quantum cryptography is working correctly!');
    console.log('🔐 Your messages are now protected with ChaCha20 encryption!');
    console.log('🚀 Ready for full Kyber1024 integration!');
...
// Run the test
testSimpleQuantumCrypto().catch(console.error); 