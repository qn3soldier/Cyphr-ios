-- USER WALLETS TABLE FOR LOBSTR-LIKE SYSTEM
-- This is CRITICAL for the new wallet architecture!
...
COMMENT ON TABLE user_wallets IS 'HD wallets bound to user accounts with encrypted seed storage - LOBSTR-LIKE SYSTEM';
