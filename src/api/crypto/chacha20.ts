...
class ChaCha20 {
  ...
  quarterRound(state: Uint32Array, a: number, b: number, c: number, d: number): void {
  ...
  chacha20Block(key: Uint8Array, nonce: Uint8Array, counter: number): Uint8Array {
    // Constants
    const constants = [
  ...
  // Generate keystream
  generateKeystream(key: Uint8Array, nonce: Uint8Array, length: number): Uint8Array {
  ...
  encryptWithRandomNonce(plaintext: Uint8Array, key: Uint8Array): Uint8Array {
  ...
  decryptWithNoncePrefix(data: Uint8Array, key: Uint8Array): Uint8Array {
